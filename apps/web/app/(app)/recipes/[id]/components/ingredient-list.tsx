...
export function ReadonlyIngredientsList({ ingredients, systemUsed }: { ingredients: any[], systemUsed: string }) {
    ...
    <ul className="space-y-2">
      {ingredients
        ...
        .map((it, idx) => {
          ...
          return (
            <li key={`${it.ingredientName}-${idx}`} className="px-3 py-2.5">
              <div className="flex flex-wrap items-baseline gap-x-1.5 gap-y-0.5">
                ...
                <span className="text-base text-foreground">
                  <SmartMarkdownRenderer text={it.ingredientName} />
                </span>
              </div>
            </li>
          );
