 ...
 *
 * Bring! fetches `recipeUrl` server-side and parses itemprop="recipeIngredient"
 * elements, then redirects the user into the Bring! app on mobile or the Bring!
 * web app on desktop.
 *
 * Requirements:
 * - The recipe page must be publicly accessible (won't work on localhost)
 * - ingredient-list.tsx must emit itemprop="recipeIngredient" on each ingredient
 */
 ...
 *
 * Only works in native mobile contexts (React Native / iOS / Android).
